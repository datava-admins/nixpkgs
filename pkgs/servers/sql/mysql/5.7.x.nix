...
, boost, libedit, libevent, lz4, ncurses, openssl, readline, zlib, perl
...
self = stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    sha256 = "sha256-uWeJi/NgzyHEPzcpdf9WlwEA1WAhOAbnoP50tJMPS5s=";
  };
  ...
  buildInputs = [ boost libedit libevent lz4 ncurses openssl readline zlib ]
