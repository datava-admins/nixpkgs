...
let
  ...
  webUiStatic = fetchurl {
    ...
    sha256 = "sha256-Bj0PnJPuqaJ0irh2U1PUBkfiCOXNSGVuW1BA57gdFgQ=";
  };
in
buildGoModule rec {
  pname = "prometheus";
  ...
  src = fetchFromGitHub {
    ...
    owner = "prometheus";
    repo = "prometheus";
    sha256 = "sha256-QXqYtwPpbD7gJHaPGjgss+yiJmPJqou3uoxdpdQb0dI=";
  };

  vendorSha256 = "sha256-/C2M/odu0pTF1REo8Sq+PQvGUKl9bqpNDR2ijdub+7U=";
